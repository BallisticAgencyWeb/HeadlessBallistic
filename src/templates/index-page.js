...
export const IndexPageTemplate = ({
  ...
  <div>
    <Helmet titleTemplate={`${mainpitch.title} | Ballistic Agency`}>
      <title>{`${mainpitch.title}`}</title>
      <link rel="canonical" href="https://ballisticagency.com/" />
          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            ...
            <div className='lg:flex lg:flex-row-reverse'>
              ...
              <div className='relative z-10 mb-12 lg:mb-0'>
                <div className='mb-10 prose text-gray-500 mx-auto lg:max-w-none text-base sm:text-lg'>
